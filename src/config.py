...
APP_VERSION = _env("MCNETEASE_APP_VERSION", "v0.1.0.9")
...
AUDIT_MIN_ENGINE_VERSION = (
    _env_int("MCNETEASE_AUDIT_MIN_ENGINE_MAJOR", 1, 0, 999),
    _env_int("MCNETEASE_AUDIT_MIN_ENGINE_MINOR", 18, 0, 999),
    _env_int("MCNETEASE_AUDIT_MIN_ENGINE_PATCH", 0, 0, 999),
)
MCP_PORT_MIN = 1024
MCP_PORT_MAX = 65535
