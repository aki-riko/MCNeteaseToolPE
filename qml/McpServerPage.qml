                ...
                Column {
                    ...
                    Repeater {
                        model: [
                            ...
                            { "name": "get_project_overview", "mode": qsTr("只读"),
                              "detail": qsTr("读取提示词指定目录的工程结构。") },
                            { "name": "audit_project", "mode": qsTr("只读"),
                              "detail": qsTr("审核提示词指定的工程目录。") },
                            { "name": "preview_cleanup", "mode": qsTr("只读"),
                              "detail": qsTr("预览指定目录中的垃圾项。") },
                            { "name": "clean_project", "mode": qsTr("写入"),
                              "detail": qsTr("清理指定目录，要求 confirm=true。") },
                            { "name": "rewrite_project_uuids", "mode": qsTr("写入"),
                              "detail": qsTr("重写指定目录的 UUID，要求 confirm=true。") },
                            { "name": "package_project", "mode": qsTr("写入"),
                              "detail": qsTr("输出指定目录的 ZIP，要求 confirm=true。") },
                            { "name": "inspect_world_data", "mode": qsTr("只读"),
                              "detail": qsTr("读取和搜索 level.dat 与世界数据库。") },
                            { "name": "get_world_data_value", "mode": qsTr("只读"),
                              "detail": qsTr("按 token 读取未截断的完整值。") },
